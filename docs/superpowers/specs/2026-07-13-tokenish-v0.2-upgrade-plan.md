# Tokenish v0.2 — Architecture Assessment & Working Upgrade Plan
...
## 4. Product thesis for Tokenish v0.2
...
### Phase 1 — Installable MVP (v0.2.0)
...
### Phase 2 — Evidence optimizer (v0.2)
...
## 11. Success metrics (definition of done for v0.2)
...
## 12. Explicit non-goals for v0.2
...
**Packaging primary for v0.2 — which ship shape do you want first?**
